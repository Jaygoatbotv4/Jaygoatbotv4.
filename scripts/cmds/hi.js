...
onChat: async function({
  ...
  if (event.body && event.body.toLowerCase() == "hello") return message.reply("hello, I'm mica,yknow what,in the first time i saw u,i kept askin myself,why r u so attractive🥹😳?");
